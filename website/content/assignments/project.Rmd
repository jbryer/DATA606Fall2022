...
[Click here to sign-up for a presentation slot](https://docs.google.com/spreadsheets/d/13BMf7h8PF3bboEYIIxWwj2PFadMOc05sySb3Lgfs2so/edit#gid=0). Please pick one timeslot. You need to stay for all presentations during that time as there will be a peer feedback form provided. **There is a maximum of 8 slots per time period.**
